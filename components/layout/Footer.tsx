      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Find your perfect luxury stay anywhere in the world.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">+1 (555) 123-4567</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">support@luxstay.com</a></li>
            </ul>
          </div>
        </div>
